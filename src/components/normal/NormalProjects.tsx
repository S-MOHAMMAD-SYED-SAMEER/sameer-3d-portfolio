 ...
 *
 * `ProjectArticle` below is the long form, exported for that route. Both read
 * the same `Project`, so there is one project model and one set of renderers.
 */
...
export function ProjectArticle({ project }: { project: Project }) {
  ...
  return (
    <article>
      ...
      <h3 className="mt-2 text-2xl leading-snug font-medium sm:text-3xl">{project.title}</h3>
